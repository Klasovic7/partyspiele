...
// v124: zweite Bilder-Kategorie ("Freunde") neben den Fußballern - beide
...
function renderIconKarussell() {
  // v124: bei "Freunde" steht die Rolle (groß) über dem Namen (klein) - bei
  ...
  // v124: lange, nicht umbrechbare Wörter (z. B. "MEERJUNGFRAU") ragen sonst
...
// v124: Umschalten zwischen den Bilder-Kategorien "Fußballer" und "Freunde".
...
function zeigeProfilAuswahl() {
  if (profilScreen.hidden) {
    ...
    // v124: Kategorie passend zum bereits gewählten Bild vorauswählen (falls
