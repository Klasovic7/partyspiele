...
// v127: zweite Bilder-Kategorie ("Freunde") neben den Fußballern - beide
...
function renderIconKarussell() {
  // v127: bei "Freunde" steht die Rolle (groß) über dem Namen (klein) - bei
  ...
  // v127: lange, nicht umbrechbare Wörter (z. B. "MEERJUNGFRAU") ragen sonst
...
// v127: Umschalten zwischen den Bilder-Kategorien "Fußballer" und "Freunde".
...
function zeigeProfilAuswahl() {
  if (profilScreen.hidden) {
    ...
    // v127: Kategorie passend zum bereits gewählten Bild vorauswählen (falls
