...
// v123: zweite Bilder-Kategorie ("Freunde") neben den Fußballern - beide
...
function renderIconKarussell() {
  // v123: bei "Freunde" steht die Rolle (groß) über dem Namen (klein) - bei
  ...
  // v123: lange, nicht umbrechbare Wörter (z. B. "MEERJUNGFRAU") ragen sonst
...
// v123: Umschalten zwischen den Bilder-Kategorien "Fußballer" und "Freunde".
...
function zeigeProfilAuswahl() {
  if (profilScreen.hidden) {
    ...
    // v123: Kategorie passend zum bereits gewählten Bild vorauswählen (falls
